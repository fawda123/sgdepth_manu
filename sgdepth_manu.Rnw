...
pdf('figs/FigS1.pdf', height = 5.5, width = 5, family = 'serif')
p1
dev.off()
@
\begin{figure}
...
pdf('figs/FigS2.pdf', height = 8, width = 8, family = 'serif')
grid.arrange(pA, p1leg, pB, blankPanel, pC, p3leg, pD, blankPanel, 
  ncol = 2, nrow = 4, 
  widths = c(1, 0.2), heights = c(1, 0.7, 1, 0.7))
dev.off()
...
pdf('figs/FigS3.pdf', height = 7.5, width = 7, family = 'serif')
grid.arrange(p1, p1leg, p2, p3, p3leg, p4, ncol = 3, nrow = 2, 
  widths = c(1, 0.3, 0.75))
dev.off()
@
...
pdf('figs/FigS4.pdf', height = 8.5, width = 6.5, family = 'serif')
grid.arrange(p1, p1leg, p2, p3, p3leg, p4, ncol = 3, nrow = 2, 
  widths = c(1, 0.3, 0.75))
dev.off()
