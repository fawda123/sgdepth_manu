...
cap.val <- "Summary of seagrass depth estimates (m) from all grid locations in \\cref{fig:all_ests}.  Whole segment estimates were obtained from all seagrass depth data for each segment."
