...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Mon Feb 13 10:01:37 2017 -0600
	}
\date{}
\maketitle
\end{singlespace}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}unit.pmax"{}}}\end{kframe}
\end{knitrout}
\begin{figure}
\centering
