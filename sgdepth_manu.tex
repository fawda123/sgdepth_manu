...
Uncertainty associated with the \ac{doc} estimates suggested that, in most cases, confidence intervals were within acceptable limits (\cref{fig:all_sens,tab:sens_summ}).  All estimates were 
