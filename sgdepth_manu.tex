...
\end{equation}
\noindent Variation in seagrass light requirements by location can be considered biologically meaningful.  Relatively high values are locations where seagrasses are more light limited (i.e., higher light requirements) than locations with lower values.   \citet{Duarte91} indicate that minimum light requirements for seagrass are on average 11\% of surface irradiance, although requirements are species-specific and variable by latitude such that values may range from less than 5\% to greater than 30\% \citep{Dennison93}.  
