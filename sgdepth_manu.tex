...
\hline\hline
\multicolumn{1}{l}{Bay segment\textsuperscript{\textit{a}}}&\multicolumn{1}{c}{Min year}&\multicolumn{1}{c}{Max year}&\multicolumn{1}{c}{$n_{Secchi}$}&\multicolumn{1}{c}{$n_{DOC}$}&\multicolumn{1}{c}{Secchi}&\multicolumn{1}{c}{$DOC_{max}$}&\multicolumn{1}{c}{\% light}\tabularnewline
\hline
