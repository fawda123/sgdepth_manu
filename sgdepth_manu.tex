...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Fri Jan 27 16:48:40 2017 -0600
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(tab, file = "", rowlabel = "Segment\\textsuperscript{\\textit{a}}",     insert.bottom = foot.val, caption = cap.val, colheads = col_heads,     cgroup = c("", "$\\mathbf Z_{c,\\,med}$", "{\\bf \\% light}"),     n.cgroup = c(1, 4, 4), caption.loc = "top", rowname = rows,     size = "small")%
\begin{table}[!tbp]
{\small
