...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Mon Aug 24 14:16:03 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
Uncertainty in $Z_{c,\,max}$ indicated that confidence intervals were generally acceptable (i.e., greater than zero), although the ability to discriminate between the three depth estimates varied by segment (\cref{fig:all_ests,tab:sens_summ}). Uncertainty for all estimates as the average width of the 95\% confidence intervals for all segments was 0.2 m.  Greater uncertainty was observed for Western Choctawhatchee Bay (mean width was 0.2 m) and Old Tampa Bay (0.4 m), compared to the Big Bend (0.1 m) and Upper Indian River Lagoon (0 m) segments.  The largest confidence interval for each segment was 2.3 m for Old Tampa Bay, 1 m for Western Choctawhatchee Bay, 4 m for the Big Bend, and 1 m for the Upper Indian River Lagoon segments.  Most confidence intervals for the remaining grid locations were much smaller than the maximum in each segment (e.g., an extreme central location of the Upper Indian River Lagoon, \cref{fig:all_ests}).  A comparison of overlapping confidence intervals for $Z_{c,\,min}$, $Z_{c,\,med}$, and $Z_{c,\,max}$ at each grid location indicated that not every measure was unique.  Specifically, only 81.5\% of grid points in Choctawhatchee Bay and 47.7\% in Old Tampa Bay had significantly different estimates, whereas 98.5\% of grid points in the Indian River Lagoon and 96.4\% of grid points in the Big Bend segments had estimates that were significantly different.  By contrast, all grid estimates in Choctawhatchee Bay and Indian River Lagoon had $Z_{c,\,max}$ estimates that were significantly greater than zero, whereas all but 11.3\% of grid points in Old Tampa Bay and 4.6\% of grid points in the Big Bend segment had $Z_{c,\,max}$ estimates significantly greater than zero. 
...
~~$Z_{c,\,min}$&1.25&1.33&0.81&0.00&2.68\tabularnewline
~~$Z_{c,\,med}$&2.46&1.71&0.75&0.47&2.90\tabularnewline
~~$Z_{c,\,max}$&3.66&2.10&0.79&0.74&3.33\tabularnewline
\hline
{\bfseries OTB}&&&&&\tabularnewline
~~$Z_{c,\,min}$&0.61&0.58&0.31&0.00&1.23\tabularnewline
~~$Z_{c,\,med}$&0.88&0.89&0.29&0.30&1.64\tabularnewline
...
\hline
BB&0.14&0.49&0.00&3.99\tabularnewline
OTB&0.44&0.43&0.05&2.30\tabularnewline
UIRL&0.04&0.08&0.00&0.98\tabularnewline
WCB&0.20&0.20&0.06&0.99\tabularnewline
\hline
\end{tabular}\end{center}
...
~~CCB&130&&2.4&0.3&0.4&3.4&&46.6&10.1&10.6&86.2\tabularnewline
~~ECB&7&&0.8&0.1&0.7&0.9&&70.9& 5.3&64.8&80.0\tabularnewline
~~WCB&130&&2.6&0.2&1.9&2.9&&45.9& 6.3&23.4&68.0\tabularnewline
\hline
